...
all_dicts = [dict_91802, dict_60079, dict_40805, dict_50098, dict_50099]

# Note that observation 50098 has the lock-on problem, so maybe it should not be included
# 50099 has to be treated slightly differently since the data ends at 3% transmission, and our analysis for the other stuff goes to 1%